...
const scenarioId = "scenario-05" as const;
 ...
 */
export const scenario05Ids = {
  scenarioId,

  challenges: {
    crossFunctionalOwnership: challenge01Id,
    dataFoundation: challenge02Id,
    partnershipGovernance: challenge03Id,
  },

  choices: {
    crossFunctionalOwnership: {
      workingGroup: challenge01Choice01Id,
      financeOnly: challenge01Choice02Id,
      independentDepartments: challenge01Choice03Id,
    },

    dataFoundation: {
      existingSources: challenge02Choice01Id,
      multinationalBenchmark: challenge02Choice02Id,
      communicationFirst: challenge02Choice03Id,
    },

    partnershipGovernance: {
      pppCanvas: challenge03Choice01Id,
      technologyOnly: challenge03Choice02Id,
      visibilityFirst: challenge03Choice03Id,
    },
  },
} as const;

export const scenario05Definition = defineScenarioDefinition<"scenario-05">({
  id: scenarioId,
  slug: scenarioId,
  ...
  assets: {
    preStartBackground: "/scenarios/scenario-05/pre-start.png",
    inProgressBackground: "/scenarios/scenario-05/in-progress.png",
  },
