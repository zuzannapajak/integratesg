...
const scenarioId = "scenario-03" as const;
 ...
 */
export const scenario03Ids = {
  scenarioId,

  challenges: {
    frameworkSelection: challenge01Id,
    priorityIndicators: challenge02Id,
    dataGovernance: challenge03Id,
  },

  choices: {
    frameworkSelection: {
      layeredApproach: challenge01Choice01Id,
      gwoOnly: challenge01Choice02Id,
      allFrameworks: challenge01Choice03Id,
    },

    priorityIndicators: {
      materialitySet: challenge02Choice01Id,
      positiveOnly: challenge02Choice02Id,
      copyCorporate: challenge02Choice03Id,
    },

    dataGovernance: {
      governedWorkflow: challenge03Choice01Id,
      annualExcel: challenge03Choice02Id,
      outsourceEverything: challenge03Choice03Id,
    },
  },
} as const;

export const scenario03Definition = defineScenarioDefinition<"scenario-03">({
  id: scenarioId,
  slug: scenarioId,
  ...
  assets: {
    preStartBackground: "/scenarios/scenario-03/pre-start.png",
    inProgressBackground: "/scenarios/scenario-03/in-progress.png",
  },
