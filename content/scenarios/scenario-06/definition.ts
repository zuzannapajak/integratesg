...
const scenarioId = "scenario-06" as const;
 ...
 */
export const scenario06Ids = {
  scenarioId,

  challenges: {
    kpiSelection: challenge01Id,
    dataQuality: challenge02Id,
    stakeholderReporting: challenge03Id,
  },

  choices: {
    kpiSelection: {
      coreKpis: challenge01Choice01Id,
      measureEverything: challenge01Choice02Id,
      copyCorporate: challenge01Choice03Id,
    },

    dataQuality: {
      dataModelAndGovernance: challenge02Choice01Id,
      singleExcel: challenge02Choice02Id,
      waitForSoftware: challenge02Choice03Id,
    },

    stakeholderReporting: {
      tailoredReporting: challenge03Choice01Id,
      singleReport: challenge03Choice02Id,
      positiveOnly: challenge03Choice03Id,
    },
  },
} as const;

export const scenario06Definition = defineScenarioDefinition<"scenario-06">({
  id: scenarioId,
  slug: scenarioId,
  ...
  assets: {
    preStartBackground: "/scenarios/scenario-06/pre-start.png",
    inProgressBackground: "/scenarios/scenario-06/in-progress.png",
  },
