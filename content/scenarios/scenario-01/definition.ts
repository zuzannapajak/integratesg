 ...
 */
export const scenario01Ids = {
  scenarioId,

  challenges: {
    pillars: challenge01Id,
    csrToEsg: challenge02Id,
    sdgAlignment: challenge03Id,
  },

  choices: {
    pillars: {
      accurateCategorisation: challenge01Choice01Id,
      rulesConfusion: challenge01Choice02Id,
      benefitConfusion: challenge01Choice03Id,
    },

    csrToEsg: {
      integrationEra: challenge02Choice01Id,
      relabelCsr: challenge02Choice02Id,
      imageOnly: challenge02Choice03Id,
    },

    sdgAlignment: {
      preciseMapping: challenge03Choice01Id,
      allClimateAction: challenge03Choice02Id,
      noStakeholderLink: challenge03Choice03Id,
    },
  },
} as const;

export const scenario01Definition = defineScenarioDefinition<"scenario-01">({
  id: scenarioId,
  slug: scenarioId,
