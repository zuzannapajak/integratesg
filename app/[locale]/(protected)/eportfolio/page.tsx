...
export default async function EPortfolioPage({ params }: Props) {
  ...
  return (
    <ComingSoonPage
      locale={locale}
      badge="Coming soon"
      title="ePortfolio is being prepared"
      description="We are working on this section. It will be available soon and will help you collect, organise and present your learning progress."
    />
  );
}
