...
export default async function ScenariosPage({ params }: Props) {
  ...
  return (
    <ComingSoonPage
      locale={locale}
      badge="Coming soon"
      title="Scenario Simulator is coming soon"
      description="We are currently preparing this module. Soon you will be able to practise ESG-related decisions through interactive scenarios."
    />
  );
}
