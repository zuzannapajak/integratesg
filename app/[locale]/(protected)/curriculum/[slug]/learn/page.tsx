...
export default async function CourseLearnPage({ params }: Props) {
  ...
  const returnPath = `/${locale}/curriculum/${courseModuleResult.module.slug}/learn`;
      ...
      <div className="relative mx-auto max-w-360 px-4 pt-10 sm:px-6 lg:px-8 transition-all duration-300">
        {pilotGate.shouldShowGate ? (
          <CurriculumPilotEntryGate
            locale={locale}
            moduleSlug={courseModuleResult.module.slug}
            moduleTitle={courseModuleResult.module.title}
